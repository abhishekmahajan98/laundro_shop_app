...
import 'package:laundro_shop_app/components/order_pickup_box.dart';
import 'package:laundro_shop_app/models/user_model.dart';

final _firestore = Firestore.instance;
FirebaseUser loggedInUser;

class OrderPickupStream extends StatelessWidget {
  @override
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        for (var message in messages) {
          ...
          final OrderPickupBox order = OrderPickupBox(
            orderId: orderId,
